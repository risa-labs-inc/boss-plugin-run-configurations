...
**Run Configurations (Dynamic)** (`ai.rever.boss.plugin.dynamic.runconfigurations`) is a dynamic plugin for the BOSS desktop application.

Auto-detect and run project configurations

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.runconfigurations`
- **Main Class**: `ai.rever.boss.plugin.dynamic.runconfigurations.RunConfigurationsDynamicPlugin`
- **API Version**: 1.0.20
